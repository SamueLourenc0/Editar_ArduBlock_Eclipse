...
public class GenerateCodeButtonListener implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		for (RenderableBlock renderableBlock:renderableBlocks)
		{
			...
			{
				if (block.getGenusName().equals("basicota"))
				{
					loopBlockSet.add(renderableBlock);
				}
				if (block.getGenusName().equals("ota"))
				{
					loopBlockSet.add(renderableBlock);
				}
			
				if (block.getGenusName().equals("bota"))
				{
					loopBlockSet.add(renderableBlock);
				}
				if (block.getGenusName().equals("Ni_GuiarPorBluetooth"))
				{
					loopBlockSet.add(renderableBlock);
				}
