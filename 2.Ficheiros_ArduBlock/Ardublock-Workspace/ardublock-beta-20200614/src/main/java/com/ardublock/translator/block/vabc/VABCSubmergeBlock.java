...
public class VABCSubmergeBlock extends TranslatorBlock{

	public VABCSubmergeBlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label){
