...
public class BasicOTABlock extends TranslatorBlock
{
	private List<String> setupCommand;
	
	public BasicOTABlock(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
	...
	public String toCode() throws SocketNullException, SubroutineNotDeclaredException
	{
		...
		if (ssid.equals("ssid") && password.equals("password")) {
			...
			translator.addHeaderFile("ArduinoOTA.h");// Adiciona a livraria OTA.h
