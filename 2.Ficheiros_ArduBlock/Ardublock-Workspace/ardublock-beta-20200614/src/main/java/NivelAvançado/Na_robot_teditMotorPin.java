...
public class Na_robot_teditMotorPin extends TranslatorBlock{

	
	public Na_robot_teditMotorPin (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label){
